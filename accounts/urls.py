...
urlpatterns = [
    ...
    path("provider-detail/",ProviderView.as_view({"get":"retrieve"}), name="retrieve-provider"),
    ...
    path("mpesatransaction/", MpesaTransactions.as_view({"get":"retrieve"}),name="mpesatransactions")
]
